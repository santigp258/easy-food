$(document).ready(function () {
  //Change important
  var baseURL = "http://localhost/easy-food";
    ...
    if (fields.usernameEmail && fields.password) {
      ...
      $.ajax({
        ...
        if (resp === "done") {
          ...
          var success =
            "<script src='" + baseURL + "/admin/views/plugins/toastr/infoLogin.js'></script>";
          $(document.body).append(success);
          setTimeout(() => {
            window.location.replace(baseURL + "/admin/index.php");
          }, 2000);
        } else {
          var error =
            "<script src='" +
            baseURL +
            "/admin/views/plugins/toastr/errorLogin.js'></script>";
